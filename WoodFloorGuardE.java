package choice;
import java.awt.*;
public class WoodFloorGuardE extends GameObject{
	
	public WoodFloorGuardE (int AbsoluteX, int AbsoluteY, GameMode gameinfo, List list, Dialogue log, GameSprite sprite)
	{
	...
	public void paintComponent(Graphics g)
	{
		...
		// Will running - triggers NightofHorrors
