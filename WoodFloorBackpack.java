...
public class WoodFloorBackpack extends GameObject{
	...
	{
		// If Alva has not retrieved Backpack
		if( list.checkNightMonster() == true && list.checkRetrieveBackpack() == false)
		{
			list.actRetrieveBackpack();
			log.readDialogue(100);
		}
		
		if((list.checkSacrifice() == true && gameinfo.getRoom() == 19 && list.checkRetrieveOldScrewdriver() == false) == true)
		{
			log.readDialogue(135);
		}
		
		if((list.checkSacrifice() == true && gameinfo.getRoom() == 19 && list.checkRetrieveOldScrewdriver() == true) == true)
		{
			log.readDialogue(136);
		}
	}
	...
	public void paintComponent(Graphics g)
	{
		...
		// If Alva hasn't picked up her Backpack OR Exit Hall and Alva sacrificed herself to save Will
		if((list.checkNightMonster() == true && list.checkRetrieveBackpack() == false) || (gameinfo.getRoom() == 19) == true && list.checkSacrifice() == true)
		{
			move = false;
