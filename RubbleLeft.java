package choice;
import java.awt.*;
public class RubbleLeft extends GameObject{
	
	public RubbleLeft (int AbsoluteX, int AbsoluteY, GameMode gameinfo, List list, Dialogue log, GameSprite sprite)
	{
	...
	{		
		...
		g.fillRect(RelativeX, RelativeY, 30, 50);		
